...
[true, false].forEach((open) => {
  ...
  .add('flyout without header', () => <ModalWrapper isFlyout={true} showHeader={false} initialShowModal={open}/>)
  .add('flyout without footer', () => <ModalWrapper isFlyout={true} showButtons={false} initialShowModal={open}/>)
  .add('flyout without header and footer', () => <ModalWrapper isFlyout={true} showHeader={false} showButtons={false} initialShowModal={open}/>)
